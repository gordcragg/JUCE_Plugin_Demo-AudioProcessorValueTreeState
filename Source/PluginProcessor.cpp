...
JuceDemoPluginAudioProcessor::JuceDemoPluginAudioProcessor()
    : AudioProcessor (BusesProperties().withInput  ("Input",  AudioChannelSet::stereo(), true)
      ...
      undoRedoManager(),
	  pluginState (*this, &undoRedoManager),
	  range (0.f, 1.f),
      lastUIWidth (450),
      lastUIHeight (200),
      delayPosition (0)
{
    ...
    pluginState.createAndAddParameter ("gainParam", "Gain", "", range, range.snapToLegalValue (0.9f), nullptr, nullptr);
	pluginState.createAndAddParameter ("delayParam", "Delay Feedback", "", range, range.snapToLegalValue (0.5f), nullptr, nullptr);

    initialiseSynth();
    
    pluginState.state = ValueTree (Identifier ("JuceDemoPlugin"));
	pluginState.undoManager->clearUndoHistory();
}
...
void JuceDemoPluginAudioProcessor::applyGain (AudioBuffer<FloatType>& buffer, AudioBuffer<FloatType>& delayBuffer)
{
    ...
    const float gainLevel = *pluginState.getRawParameterValue ("gainParam");
...
{
    const int numSamples = buffer.getNumSamples();
    const float delayLevel = *pluginState.getRawParameterValue ("delayParam");
